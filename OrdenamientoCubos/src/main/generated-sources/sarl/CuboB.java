...
public class CuboB extends Agent {
  private int posicionCuboB;

  private int posicionDeseada = 3;

  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    Logging _$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER = this.$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER();
    _$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER.setLoggingName("CuboB");
    this.posicionCuboB = 2;
    ...
    final Procedure1<Agent> _function = (Agent it) -> {
      ...
      if ((_numberOfStrongParticipants > 3)) {
        if ((this.posicionCuboB == this.posicionDeseada)) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    CuboB other = (CuboB) obj;
    if (other.posicionCuboB != this.posicionCuboB)
      return false;
  ...
  public int hashCode() {
    ...
    final int prime = 31;
    result = prime * result + Integer.hashCode(this.posicionCuboB);
    result = prime * result + Integer.hashCode(this.posicionDeseada);
    return result;
  }

  @SyntheticMember
  public CuboB(final UUID parentID, final UUID agentID) {
    super(parentID, agentID);
  }

  @SyntheticMember
  @Inject
  public CuboB(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
