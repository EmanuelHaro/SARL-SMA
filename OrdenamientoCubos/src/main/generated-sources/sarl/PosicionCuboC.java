...
public class PosicionCuboC extends Event {
  public final int posActual;

  public final int posDeseada;

  public PosicionCuboC(final int i, final int j) {
    this.posActual = i;
    this.posDeseada = j;
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    PosicionCuboC other = (PosicionCuboC) obj;
  ...
  /**
   * Returns a String representation of the PosicionCuboC event's attributes only.
   */
  @SyntheticMember
  @Pure
