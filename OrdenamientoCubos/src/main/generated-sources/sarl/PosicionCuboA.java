...
public class PosicionCuboA extends Event {
  public final int posActual;

  public final int posDeseada;

  public PosicionCuboA(final int i, final int j) {
    this.posActual = i;
    this.posDeseada = j;
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    PosicionCuboA other = (PosicionCuboA) obj;
  ...
  /**
   * Returns a String representation of the PosicionCuboA event's attributes only.
   */
  @SyntheticMember
  @Pure
