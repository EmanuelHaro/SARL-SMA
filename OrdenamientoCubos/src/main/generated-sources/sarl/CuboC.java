...
public class CuboC extends Agent {
  private int posicionCuboC;

  private final int posicionDeseada = 2;

  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    Logging _$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER = this.$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER();
    _$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER.setLoggingName("CuboC");
    ...
    final Procedure1<Agent> _function = (Agent it) -> {
      ...
      if ((_numberOfStrongParticipants > 3)) {
        if ((this.posicionCuboC == this.posicionDeseada)) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    CuboC other = (CuboC) obj;
    if (other.posicionCuboC != this.posicionCuboC)
      return false;
  ...
  public int hashCode() {
    ...
    final int prime = 31;
    result = prime * result + Integer.hashCode(this.posicionCuboC);
    result = prime * result + Integer.hashCode(this.posicionDeseada);
    return result;
  }

  @SyntheticMember
  public CuboC(final UUID parentID, final UUID agentID) {
    super(parentID, agentID);
  }

  @SyntheticMember
  @Inject
  public CuboC(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
