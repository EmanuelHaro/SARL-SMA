...
public class PosicionMesa extends Event {
  public final int posActual;

  public final int posDeseada;

  public PosicionMesa(final int i, final int j) {
    this.posActual = i;
    this.posDeseada = j;
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    PosicionMesa other = (PosicionMesa) obj;
  ...
  /**
   * Returns a String representation of the PosicionMesa event's attributes only.
   */
  @SyntheticMember
  @Pure
