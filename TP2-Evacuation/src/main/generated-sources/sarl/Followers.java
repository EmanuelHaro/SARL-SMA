...
public class Followers extends Agent {
  ...
  @SyntheticMember
  public Followers(final UUID parentID, final UUID agentID) {
    super(parentID, agentID);
  }

  @SyntheticMember
  @Inject
  public Followers(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
