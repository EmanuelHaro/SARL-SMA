...
public class Panic_Stricken extends Agent {
  ...
  @SyntheticMember
  public Panic_Stricken(final UUID parentID, final UUID agentID) {
    super(parentID, agentID);
  }

  @SyntheticMember
  @Inject
  public Panic_Stricken(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
